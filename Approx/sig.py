...
def me(x,y):
    return numpy.fabs(x - y)
def mer(x,y):
    return numpy.fabs((x - y)/x)
...
if __name__ == '__main__':
    ...
    #plt.plot(x,  numpy.fabs(y- scipy.special.expit(x)), label='scipy')
    #plt.plot(x,  Taylor_3(x), label='T3')
    #plt.plot(x,  y-Taylor_5(x), label='T5')
    ...
    plt.plot(x,  numpy.fabs(y-faie(x,res.x.astype(numpy.float16))), label='P3'+'Nelder-Mead')

    p = numpy.array([ (1/2), (1/4), (1/32)] )#, (1/480)])
    print(p)
    res = C(p,x,y,cost,'powell')
    print("PO",res.x.astype(numpy.float16))
    plt.plot(x,  numpy.fabs(y-faie(x,res.x.astype(numpy.float16))), label='P3'+'powell')
    ...
    p = numpy.array([ (1/2), (1/4), (1), 1, 1] )#, (1/480)])
    print(p)
    res = C(p,x,y,cost_2,'powell')
    print('CG',res.x.astype(numpy.float16))
    plt.plot(x,  numpy.fabs(y-faie(x,res.x.astype(numpy.float16))), label='P3'+'powell')


    plt.plot(x,  numpy.fabs(y-aie(x)), label='aie')
    #res = C(p,x,y,cost)
    #print(res.x)
    #plt.plot(x,  y-F(x,res.x), label='P4')
    #p = numpy.array([ (1/2), (1/4), (1/32), (1/480),1])
    #print(p)
    #res = C(p,x,y,cost)
    #print(res.x)
    #plt.plot(x,  y-F(x,res.x), label='P5')
