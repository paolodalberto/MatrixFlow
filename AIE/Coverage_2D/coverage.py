...
## For every a of A, we compute the closest HW function  
## and then compute the cost for the all set 
##
def partition_D(
    ...
    for ai in range(len(A)):
        ...
        ## for p in P, find the minimum dominant p
        for pi in P:

            # if a == p: then the cost is 0
            ...
            p = A[pi]
            w = 1
            ## d_i = Ceil(a_i/p_i)*p_i -p_i
            ## padding = cost  = prod d_i
            ...
            if b>w   : b = w ## minimum
            if b == 0: break ##  I Cannot do better 
