...
little extra information. Now let us introduce the partition and how
the computation can be described in parallel and sequential parts.

As soon as we define $P_+(\Vc{X})_i = \sum_j x_{i,j}$ and $N_*(\Vc{X},
...
Here we discuss the implementation and computation of 
